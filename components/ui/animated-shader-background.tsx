...
export type AnimatedShaderBackgroundProps = {
  className?: string;
  /** Merged onto the root; overrides default `minHeight` when set (e.g. docs preview). */
  style?: CSSProperties;
 ...
 * Sizes to its container via ResizeObserver (default minHeight is 100vh).
 */
...
/** Alias for snippets that import this component as `AnoAI`. */
